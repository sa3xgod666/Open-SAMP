...
#define SAMP_VERSION "0.1-beta"
#define NETGAME_VERSION 4057 // From SAMP
...
typedef struct {
	...
	unsigned short udAnalog;				// +2
	unsigned short wKeys;					// +4
	VECTOR vecPos;					// +6
	//CQuaternion quat;				// +18
	//float xx, yy, zz, 
	unsigned char byteHealth;				// +34
	unsigned char byteArmour;				// +35
	unsigned char byteCurrentWeapon;		// +36
	unsigned char byteSpecialAction;		// +37
	VECTOR vecMoveSpeed;			// +38
	VECTOR vecSurfOffsets;			// +50
	unsigned short wSurfInfo;				// +62
	unsigned int dwAnimation;			// 64
} ONFOOT_SYNC_DATA;
