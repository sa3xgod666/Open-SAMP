...
public:
	...
	bool New(PLAYERID bytePlayerID, PCHAR szPlayerName);
	bool Delete(PLAYERID bytePlayerID, BYTE byteReason);
	...
	void SetLocalPlayerID(PLAYERID byteID) {
